...
@section('content')
    <div class="content-item">
        <div class="content-header my-2">
            <h3>ویرایش بخش نظر مشتری</h3>
        </div>
        <div class="my-2">
            {!! Form::model($testimonial, ['method' => 'PUT', 'route' => ['testimonial.update', $testimonial->id], 'files' => true]) !!}
            <div class="form-group">
                {!! Form::label('image', 'تصویر مشتری') !!}
                {!! Form::file('image', null) !!}
                <p class="mt-2">
                    <img src="{{ asset('admin/images/testimonial/' . $testimonial->image) }}" width="150px" alt="">
                </p>
                @error('image')
